const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_CATERPIE] = _("KOKANA"),
    [SPECIES_METAPOD] = _("KOKOON"),
    [SPECIES_BUTTERFREE] = _("BUTTERFRY"),
    ...
    [SPECIES_PIKACHU] = _("RAITORA"),
    [SPECIES_RAICHU] = _("GOROTORA"),
    ...
    [SPECIES_VENONAT] = _("COMBEE"),
    [SPECIES_VENOMOTH] = _("VESPIQUEN"),
    ...
    [SPECIES_MEW] = _("MEW"),
    [SPECIES_CHIKORITA] = _("LEEF"),
    [SPECIES_BAYLEEF] = _("BLOSSOMOLE"),
    [SPECIES_MEGANIUM] = _("BLOSSOMITE"),
    [SPECIES_CYNDAQUIL] = _("FLAMBEAR"),
    [SPECIES_QUILAVA] = _("VOLBEAR"),
    [SPECIES_TYPHLOSION] = _("DYNABEAR"),
    [SPECIES_TOTODILE] = _("CRUZ"),
    [SPECIES_CROCONAW] = _("AQUA"),
    [SPECIES_FERALIGATR] = _("AQUARIA"),
    [SPECIES_SENTRET] = _("SENTRET"),
    [SPECIES_FURRET] = _("FURRET"),
    [SPECIES_HOOTHOOT] = _("HOOTHOOT"),
    [SPECIES_NOCTOWL] = _("HOOHOO"),
    ...
    [SPECIES_TAILLOW] = _("CHIKKU"),
    [SPECIES_SWELLOW] = _("BRASTORK"),
    [SPECIES_SHROOMISH] = _("TANGEL"),
    [SPECIES_BRELOOM] = _("GELANLA"),
    ...
    [SPECIES_DUSKULL] = _("TWINZ"),
    [SPECIES_DUSCLOPS] = _("YANGORO"),
    [SPECIES_ROSELIA] = _("MLGARI"),
    [SPECIES_SLAKOTH] = _("SLAKOTH"),
    [SPECIES_VIGOROTH] = _("VIGOROTH"),
    [SPECIES_SLAKING] = _("SLAKING"),
    [SPECIES_GULPIN] = _("YOSSY"),
    [SPECIES_SWALOT] = _("ELDROSSY"),
    [SPECIES_TROPIUS] = _("TROPIUS"),
    [SPECIES_WHISMUR] = _("QUIEAT"),
    ...
    [SPECIES_SHUPPET] = _("KURSTRAW"),
    [SPECIES_BANETTE] = _("PANGSHI"),
